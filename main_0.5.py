...
▶️<a href="{"https://www.youtube.com/watch?v=gWiTiYYk_NY"}">{"УРОК ТУТ"}</a>◀️
...
▶️<a href="{"https://youtu.be/fpzwY1g1Frs"}">{"УРОК ТУТ"}</a>◀️
▶️<a href="{"https://youtu.be/fpzwY1g1Frs"}">{"УРОК ТУТ"}</a>◀️
▶️<a href="{"https://youtu.be/fpzwY1g1Frs"}">{"УРОК ТУТ"}</a>◀️
...
Приятного просмотра🥳""",
        ...
        photo_path = "C:/Users/eshki/Desktop/Alena bot test/Photo/3d_message.png"
        
        with open(photo_path, 'rb') as photo:
            bot.send_photo(call.message.chat.id, photo=photo, caption=f"""<b>Ура! Вы сделали первый шаг к финансовой свободе!</b>
